const payNetResCodes = {
  // error codes from paynet
  '00': 'Approved',
  '03': 'Invalid Seller Or Acquiring Bank Code',
  ...
  '87': 'Credit Failed Exception Handling',
  ...
  BB: 'Transaction Cancelled By Customer',
  ...
  '1A': 'Buyer Failed To Provide The Necessary Info To Login To Internet Banking Login Page',
